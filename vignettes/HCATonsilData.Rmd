...
df <- as.data.frame(df)
# The next object is available here: https://zenodo.org/record/6340174/files/20220215_tonsil_atlas_cite_seurat_obj.rds
...
table(sce$assay)
# setting this chunk to eval=FALSE, otherwise the vignette takes too long to compile
```
